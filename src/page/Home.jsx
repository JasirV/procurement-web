        ...
        <div className="p-6 bg-gray-100 flex-grow">
          ...
          <div className="flex flex-col items-center mt-6  bg-white rounded-lg shadow p-4 ">
            <div className="w-full h-full flex justify-between items-center md:px-20">
              <button className='md:p-2 border text-xs md:text-base p-1 bg-primary rounded-3xl hover:bg-secondary hover:text-white'>Create Supplier</button>
              <button className='md:p-2 md:px-6 border text-xs md:text-base p-1 bg-primary rounded-3xl hover:bg-secondary hover:text-white'>Add Item</button>
              <button className='md:p-2 border bg-primary text-xs md:text-base p-1 rounded-3xl hover:bg-secondary hover:text-white'>PurchseOrder</button>
              <button className='md:p-2 md:px-7 border bg-primary text-xs md:text-base p-1 rounded-3xl hover:bg-secondary hover:text-white'>History</button>
            </div>
          </div>
        </div>
      </div>
